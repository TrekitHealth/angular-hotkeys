...
(function() {
  ...
  angular
    .module("cfp.hotkeys", [])
    .provider("hotkeys", function($injector) {
      /**
      ...
      this.$get = function(
        ...
        function toggleCheatSheet() {
          ...
          if (scope.helpVisible) {
            ...
            _add("esc", previousEsc.description, toggleCheatSheet, null, [
              "INPUT",
              "SELECT",
              "TEXTAREA"
            ]);
          ...
          if (angular.isArray(combo)) {
            ...
            if (index > -1) {
              ...
              if (scope.hotkeys[index].combo.length > 1) {
                scope.hotkeys[index].combo.splice(
                  scope.hotkeys[index].combo.indexOf(combo),
                  1
                );
              } else {
      ...
      return {
        ...
        link: function(scope, el, attrs) {
          ...
          angular.forEach(scope.$eval(attrs.hotkey), function(func, hotkey) {
            ...
            allowIn =
              typeof attrs.hotkeyAllowIn === "string"
                ? attrs.hotkeyAllowIn.split(/[\s,]+/)
                : [];
